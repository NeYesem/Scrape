...
public class Category {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		int count = 0;
		String sut_urunu = "sütyoðurtyogurtsutpeynirayrankefir";
		String et_kuru = "etyumurtabalýkbalýðýnohutfasulyebarbunyabaklabörülcefýndýkcevizbademçekirdeðifýstýðýkaju";
		String ekmek_tahýl = "ekmeklavaþsimitbulgurpirinçgevreðigevrekezmeyufkapatlamýþ mýsýrçorba"
				+ "tahýlþekerpekmeztahinhelvaçikolatacezeryedondurmabisküvikekkrakergofretbarbal";
		String yaglar = "sývýyaðtereyaðkaymakkrema";
		String meyve_sebze = "eriküzümbamyadutkirazviþnekarpuzkayýsýsarýmsakmýsýrkavunenginarpatatesmarulfasulyebiberrezeneçilekpatlýcandomatessoðanerikbarbunyahavuçbezelye"
				+ "çaðlakuþkonmazturppancarlimonpýrasamandalinamuzkerevizhindibaðlahana"
				+ "greyfurtkestanebalkabaðýkivihurmaportakalayvaarmutkarnabaharnarelmamantarýspanakbrokoli";
